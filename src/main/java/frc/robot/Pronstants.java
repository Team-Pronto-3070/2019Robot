...
public interface Pronstants {
    ...
    public static final int TALONFR_PORT = 2;
    public static final int TALONBR_PORT = 1;
    public static final int TALONFL_PORT = 3;
    public static final int TALONBL_PORT = 0;
